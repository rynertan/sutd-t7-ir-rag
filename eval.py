...
def precision_recall(row):
    ...
    return relevance, total_relevant, precision, recall, f1
...
def run_eval(path):
    ...
    df[["relevance", "total_relevant", "precision", "recall", "f1_score"]] = df.apply(
    precision_recall, axis=1, result_type="expand"
)
